...
mulai (){
    echo "Gunakan prank_project lagi?"
    echo "y/n?"
    echo
    read lagi
    if [ $lagi = "y" ]; then
            ...
            echo "Terimakasih sudah menggunakan prank_project"
    fi
}
#spam
spam(){
...
clear
troll
echo Selamat datang ,Siapa Nick lu njeng? #tulisan keluar
